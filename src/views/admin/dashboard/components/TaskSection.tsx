...
// Import Modal yang sudah kita buat
import TicketDetailModal from "./TaskDetailModal";
...
const TaskSection: FC<TaskSectionProps> = ({ tickets, isLoading }) => {
  ...
  const handleOpenModal = (ticketNumber: string) => {
  ...
  return (
    <>
      {/* Kontainer utama tetap menggunakan h-full agar merespons tinggi kolom grid */}
      <div className="bg-gray-900 border border-gray-800 rounded-xl flex flex-col h-full overflow-hidden shadow-sm">
        ...
        {/* List Container - PERUBAHAN DI SINI: Hapus max-h-[248px] */}
          ...
          {isLoading ? (
            ...
            <div className="divide-y divide-gray-800/50">
              {activeTasks.map((ticket) => (
                <div 
                  key={ticket.id} 
                  onClick={() => handleOpenModal(ticket.ticket_number)} 
            ...
            <div className="flex flex-col items-center justify-center h-full py-12 px-10 text-center">
